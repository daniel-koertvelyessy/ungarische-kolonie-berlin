    ...
    public static function handle(TransactionForm $form): Transaction
    {
        return DB::transaction(function () use ($form) {
            return Transaction::create([
                ...
                'amount_gross' => Account::makeCentInteger((int) $form->amount_gross),
                'vat' => $form->vat,
                'tax' => Account::makeCentInteger((int) $form->tax),
                'amount_net' => Account::makeCentInteger((int) $form->amount_net),
