...
<flux:card class="space-y-3 my-3 hover:bg-teal-50 dark:hover:bg-emerald-800 transition duration-500 {{ $event->event_date < now() ? 'border-zinc-600' : 'border-emerald-600' }}">
