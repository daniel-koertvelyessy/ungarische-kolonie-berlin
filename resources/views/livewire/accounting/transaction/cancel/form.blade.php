<div>
    ...
    >
        ...
        <input type="hidden" wire:model="form.transaction_id">
        ...
        <flux:button variant="danger" type="submit">{{ __('transaction.cancel-transaction-modal.btn.submit.label') }}</flux:button>
