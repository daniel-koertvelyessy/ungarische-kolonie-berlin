   ...
   <section class="lg:flex lg:flex-row gap-6">
       ...
       <flux:card class="lg:basis-1/3">
           <section class="space-y-6">
               ...
               @can('audit',$audit)
           <flux:button wire:click="approveAuditReport" variant="primary">Freigabe erteilt</flux:button>

           <flux:separator text="oder" />


               <flux:button wire:click="rejectAuditReport" variant="danger">Freigabe nicht erteilt</flux:button>
               <flux:textarea wire:model="form.reason" rows="auto" label="Begründung"/>
               @elsecan
